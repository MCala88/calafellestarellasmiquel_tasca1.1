...
-------------------------
### **asteriscos y _barra baja_**
``` **asteriscos y _barra baja_** de esta manera combinamos diferentes enfasis ```
...
```Para la lista principal es (1. Lista principal) y para la secundaria (* lista secundaria)```
...
```Se pueden poner de dos maneras, en linea y en referencia```
...
```Debes de hacer esta estructura de caracteres para hacer una tabla, puedes copiarla```
```
| Tabla         | Gatos         | lvl   |
| ------------- |:-------------:| -----:|
| 1             | bigotitos     | 27    |
...
```
------------
Debe haber al menos 3 guiones que separen cada celda de encabezado. Las tuberías externas (|) son opcionales, y no es necesario que la línea de Markdown sin procesar se alinee de manera bonita. También puede usar Markdown en línea

Markdown | Tipos | Bonitos
--- | --- | ---
*asteriscos* | `apostrofe` | **dosasteriscos**
...
> Se pueden crear textos en bloques usado generalmente para introducir correos electronicos

```Simplemente para usarlo pones (>email@gmail.com)```

-------------------------
--------------------------
# La codificación del archivo de texto es UTF-8
--------------------------
...
## git clone <url>
>Crea una copia de un repositorio remoto
## git status
>Lista todos los archivos nuevos o modificados 
## git add [-u] [filename|.|pattern]
>Hace una instantania de los archivos para versionarlos, añadirlos al Index (staged) -u añade archivos al Index que se tienen que borrar 
## git commit [-m "message"]
>Guarda les instantancias de los archivos permanentamente al historial de versiones (Index-->HEAD)
## git push origin master
>Carga todos los archivos validados de la raiz local al repositorio remoto
## git pull origin master
>Descarga e incorpora los canvios desde el repositorio remoto
